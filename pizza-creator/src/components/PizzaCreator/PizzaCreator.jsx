...
class PizzaCreator extends React.Component {
  constructor(props) {
    ...
    this.minusSelectedToppingAmount = this.minusSelectedToppingAmount.bind(
      this
    );
  ...
  render() {
    ...
    return (
      <div>
        <PizzaViewer selectedToppings={selectedToppings} />
        <form className='pizza-creator'>
          {showAtLeastAToppingError && (
            <ErrorMessage>
              Please choose at least a topping to place order!
            </ErrorMessage>
          )}
          <Details
            submitted={submitted}
